...
+ **Распределение рейтингов** - гистограмма частотности оценок IMDB

+ **Финансовый анализ** - выручка по продолжительности, топ-10 по кассовым сборам

+ **Рейтинговый анализ** - топ-10 фильмов по оценкам, средний рейтинг

## 📊 Страница 2: Статистический анализ
+ **Анализ продолжительности** - минимальная, максимальная, средняя и медианная длительность фильмов

+ **Временной анализ** - распределение фильмов по годам выпуска, первый и последний фильм в выборке

+ **Детальная статистика рейтингов** - средние, медианные значения и отклонения для рейтингов зрителей и критиков

+ **Анализ отклонений** - вариативность оценок и продолжительности фильмов

+ **Лучший фильм** - детальная информация о фильме с наивысшим рейтингом

## 🔗 Страница 3: Анализ зависимостей и распределений
+ **Корреляционный анализ** - зависимость выручки от рейтингов зрителей и критиков

+ **Жанровая статистика** - распределение фильмов по жанрам

+ **Визуализация взаимосвязей** - точечные диаграммы для выявления паттернов
...
+ **Количество фильмов по жанру** (Круговая диаграмма/Donut chart) - визуализация жанрового распределения в топ-1000
